...
```{r allsubset, include = TRUE, echo = FALSE, cache = TRUE}
fit1 <- lm(Y ~ A + W2 + W4 + W5 + W7 + W8 + W9 + W13 + W14 + W15 + W16 + W19 + W21 + W22, data = dc1)
...
```{r bestsubset, include = TRUE, echo = FALSE, cache = TRUE}
...
![knit to html to see](all_subset.png)
![knit to html to see](best_subset.png)
