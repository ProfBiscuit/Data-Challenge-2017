...
```{r MARS2, include = TRUE, echo = FALSE}
...
```{r MARS2_linear, include = TRUE, echo = FALSE}
...
```{r MARS3, include = TRUE, echo = FALSE}
mars3 <- earth(Y ~ . , 
               degree = 3, 
               #trace=1.5, 
               #nk = 40, 
...
```{r MARS3_linear, include = TRUE, echo = FALSE}
...
```{r MARS4_linear, include = TRUE, echo = FALSE}
